...
const AlertaModalNovoUsuario: React.FunctionComponent<ParentCompProps> = (props) => {
              ...
              <View style={styles.botoesView}>
                ...
                <View style={{ ...styles.botaoView, paddingLeft: 5 }}>
                  <Button
                    ...
                    onPress={() => props.onConfirmNovoUsuarioPressed()}
                  />
                </View>
              </View>
            </View>
...
export default AlertaModalNovoUsuario;